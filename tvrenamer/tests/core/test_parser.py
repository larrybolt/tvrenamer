...
class ParserTest(base.BaseTest):
    ...
    def test_parse_filename(self):
        ...
        print(result)
        self.assertEqual(result['series_name'], 'Sample-Show')
        ...
        result = parser.parse_filename(fname)
        print(result)
        self.assertEqual(result['series_name'], 'The Wire')
        ...
        result = parser.parse_filename(fname)
        print(result)
        self.assertEqual(result['series_name'], '30 Rock')
        self.assertEqual(result['season_number'], 2)
        self.assertEqual(result['episode_numbers'], [10])
    ...
    def test_parse_expr9(self):
        ...
        result = parser.parse_filename(fname)
        print(result)
        self.assertEqual(result['series_name'], 'Sample')
        self.assertEqual(result['season_number'], 2)
    ...
    def test_parse_expr10(self):
        ...
        result = parser.parse_filename(fname)
        print(result)
        self.assertEqual(result['series_name'], 'Sample_Show')
    ...
    def test_parse_expr14(self):
        ...
        result = parser.parse_filename(fname)
        print(result)
        self.assertEqual(result['series_name'], 'SampleShow')
