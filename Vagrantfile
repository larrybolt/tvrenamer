...
if hash pip 2>/dev/null; then
    ...
    apt-get update -y && apt-get install -qy git
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.synced_folder ".", "/home/vagrant/tvrenamer", type: "rsync", rsync__exclude: [".venv/", ".tox/", "cover/", "doc/build"]
